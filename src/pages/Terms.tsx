  ...
  <Layout>
    <section className="bg-navy py-16 md:py-20">
      <div className="container-narrow px-4 sm:px-6 lg:px-8 max-w-3xl">
        <h1 className="text-3xl font-bold md:text-4xl text-navy-foreground">Terms & Conditions</h1>
    ...
    <section className="section-padding bg-background">
      <div className="container-narrow max-w-3xl">
        <div className="space-y-8 text-muted-foreground leading-relaxed">
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-foreground">2. Services</h2>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-foreground">3. Intellectual Property</h2>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-foreground">4. Limitation of Liability</h2>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold text-foreground">5. Governing Law</h2>
